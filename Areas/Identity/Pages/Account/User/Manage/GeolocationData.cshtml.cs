...
{
    public class GeolocationDataModel : PageModel
    {
        ...
        public GeolocationDataModel(UserManager<ApplicationUser> userManager,
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (await _userGeolocationStore.CheckIfUserEverProvidedDataAsync(ApplicationUser) == true)
            {
                ...
                ImageData = await _userGeolocationStore.GetGeolocationImageAsync(UserGeolocation);
            }
