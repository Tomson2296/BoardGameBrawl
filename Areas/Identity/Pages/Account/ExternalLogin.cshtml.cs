    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var userClaims = Response.HttpContext.User.Claims.ToArray(); 
                var email = userClaims.First(cl => cl.Type == "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress");
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                // Creating a new user and add a basic info about them
                var user = CreateUser();
                ...
                await _userStore.SetUserLastLoginDateAsync(user, creationDate, CancellationToken.None);
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        {
                            return RedirectToPage("./RegisterConfirmation", new { Input.Username, Input.Email });
                        }
