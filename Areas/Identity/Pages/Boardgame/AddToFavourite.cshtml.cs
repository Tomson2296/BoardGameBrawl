...
{
    public class AddToFavouriteModel : PageModel
    {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IBoardGameStore<BoardgameModel> _boardgameStore;

        public AddToFavouriteModel(UserManager<ApplicationUser> userManager, IBoardGameStore<BoardgameModel> boardgameStore)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                // add new entity to end of the list 
                BoardgameFavourites.Add(Boardgame.BGGId.ToString());
