...
namespace BoardGameBrawl.Areas.Identity.Pages.Schedule
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(UserManager<ApplicationUser> userManager, IUserScheduleStore<UserSchedule, ApplicationUser> userScheduleService)
        {
        ...
        private static void CreateDivParameters(UserSchedule schedule, IList<string> posParams, 
        ...
        private static void SetUpParameters(IList<string> daySchedule, IList<string> posParams, 
        ...
        public async Task<IActionResult> OnPostClearSchedule()
        {
            ApplicationUser = await _userManager.GetUserAsync(User);
            await _userScheduleStore.ClearUserScheduleAsync(ApplicationUser.Id);
